...
export function CommandNodeComponent({ data, selected }: Props) {
  return (
    <div
      className={`bg-blue-500 text-white px-4 py-2 rounded shadow text-sm font-medium text-center relative break-words whitespace-normal ${selected ? 'border-2 border-blue-600' : ''}`}
