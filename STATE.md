...
- 2026-04-22: Modified `ralph.sh` to use the `gemini-3-flash` model for all agent interactions. Optimized the RALPH loop to avoid exhaustive test coverage verification on the first iteration, improving startup speed.
